...
/**
 * Central mutable app state. Modules import and read/write this object.
 */
export const state = {
  assets: [...DEFAULT_ASSETS],
  currentTab: restoreActiveAsset(),
  editIdx: null,
  data: {},                 // { symbol: [ {id, tanggal, hargaBeli, jumlahUnit, totalBeli} ] }
  user: null,               // Firebase user or null
  showInstrumentForm: false,
  showAllRows: {},          // { symbol: bool }
...
// ---------- localStorage helpers (UI persistence only, no data of record) ----------
