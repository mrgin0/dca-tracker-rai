...
export function renderTabs() {
  ...
  $('tabs').innerHTML = tabs +
    `<button class="tab add-instrument" data-action="toggle-instrument"><i class="fa fa-plus"></i> Instrumen</button>`;
}

export function renderInstrumentPanel() {
  $('instrument-panel').hidden = !state.showInstrumentForm;
}
